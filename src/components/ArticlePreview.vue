...
article {
  ...
  box-shadow: 0 2.5rem 2.5rem -0.625rem var(--color-shadow-primary);
  ...
  .text-content {
    ...
    h1 {
      ...
      @media #{$laptop-and-bigger} {
        ...
        letter-spacing: calc(0.25 / 16 * 1em);
      }
    }
  ...
  .share-section {
    padding: 1.5rem var(--padding-inline) 1.25rem;
    position: relative;
    display: flex;
    align-items: center;
    gap: 1rem;
